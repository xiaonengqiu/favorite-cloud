/*
package com.gfs.favorite.util.redis;

import com.gfs.favorite.domain.User;
import com.gfs.favorite.service.RedisService;
...
public class TestRedis {
    ...
    public void testObj() throws Exception {
    	BoundValueOperations<String, User> ops = redisTemplate.boundValueOps("favorite");
